...
% generate functions
x_in = pn_seq(L,1,N);       %input (+N transient)
% x = circshift(pn_seq(L,1,0),L-N,2);  %to compare (known at the receiver)
...
SNR_theo_corr = SNR(sigma2w, L,h, H_ls,'theo_corr');        %adjust input params
SNR_theo_ls = SNR(sigma2w, L,h, H_ls,'theo_ls');        %adjust input params
